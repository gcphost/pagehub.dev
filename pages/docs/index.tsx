          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {docs.map((doc) => (
              <Link key={doc.href} href={doc.href}>
                <div className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 p-6 cursor-pointer border border-gray-100">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Page Builder API</h3>
                  <p className="text-sm text-gray-600">API endpoints and usage</p>
                </div>
              </a>
              <a
                href="/templates"
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Pre-built page templates</p>
                </div>
              </a>
            </div>
          </div>
