        ...
        <AnimatePresence>
          ...
          >
            <motion.button
              ref={ref}
              className={
                "hover:bg-primary/90 inline-flex h-8 items-center justify-center gap-2 whitespace-nowrap rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow transition-colors focus:outline-none focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0"
              }
              style={{
                willChange: "transform",
                backfaceVisibility: "hidden",
